...
<%@include file="/WEB-INF/views/admin/layout/head/adminHead.jsp" %>
<%@include file="/WEB-INF/views/admin/layout/sidebar/adminSideBar.jsp" %>
...
<%@include file="/WEB-INF/views/admin/layout/footer/adminFooter.jsp" %>
<%@include file="/WEB-INF/views/admin/layout/scripts/adminScripts.jsp" %>