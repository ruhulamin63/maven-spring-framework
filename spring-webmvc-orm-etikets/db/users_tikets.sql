...
CREATE TABLE `tikets` (
  ...
  PRIMARY KEY (`id`),
  KEY `user_id_tiket_pk_idx` (`user_id`),
  CONSTRAINT `user_id_tiket_pk` FOREIGN KEY (`user_id`) REFERENCES `register` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2022-04-14 20:52:46
